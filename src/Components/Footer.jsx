...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center justify-center w-full py-20 bg-linear-to-r from-emerald-400 to-teal-500 hover:from-emerald-500 text-white/70 hover:text-white transition-colors">
      {/* 🌱 EcoTrack logo */}
<div className="flex items-center">      <svg
        ...
        fill="none"
      >
        <mask id="mask0" maskUnits="userSpaceOnUse" x="35" y="0" width="130" height="200">
        ...
        <defs>
          <linearGradient id="paint0" x1="35.5469" y1="119.54" x2="164.282" y2="119.54" gradientUnits="userSpaceOnUse">
            <stop stopColor="#54CB76" />
            <stop offset="1" stopColor="#8CE2A6" />
          </linearGradient>
          <linearGradient id="paint1" x1="116.298" y1="0" x2="116.298" y2="166.066" gradientUnits="userSpaceOnUse">
            <stop stopColor="#7DD474" />
            <stop offset="1" stopColor="#59C04F" />
          </linearGradient>
          <linearGradient id="paint2" x1="68.0478" y1="40.2302" x2="68.0478" y2="166.109" gradientUnits="userSpaceOnUse">
