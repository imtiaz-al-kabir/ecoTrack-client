...
const Footer = () => {
  return (
    <footer className="w-full bg-linear-to-r from-emerald-500/90 to-teal-500/80 text-white py-10">
      ...
      <div className="mt-6 text-center text-xs text-white/80 px-4">
        <p>
          EcoTrack is committed to an inclusive experience for all users. We
          respect your privacy and strive to make sustainability accessible to
          everyone. 🌎
        </p>
      </div>
    </footer>
